...
class QuizScreenAr extends StatefulWidget {
  const QuizScreenAr({super.key});

  @override
  State<QuizScreenAr> createState() => _QuizScreenArState();
}

class _QuizScreenArState extends State<QuizScreenAr> {
