...
class DRInsertDataAR extends StatefulWidget {
  const DRInsertDataAR({Key? key}) : super(key: key);

  @override
  State<DRInsertDataAR> createState() => _DRInsertDataARState();
}

class _DRInsertDataARState extends State<DRInsertDataAR> {
